...
1. Configure the google scholar citation crawler:
    ...
    1. Enable the workflow on the repository's **Actions** page. It can be run manually and runs automatically every other day at 08:17 UTC. It writes `gs_data.json` and the badge endpoint data to the `google-scholar-stats` branch.
...
1. Add your homepage content in `_pages/about.md`.
    ...
    1. You can use a `<span>` tag with class `show_paper_citations` and attribute `data-paper-id` to display the citations of your paper. Set the attribute to the Google Scholar paper ID. For example:
        ```html
